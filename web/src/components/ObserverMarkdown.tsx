...
// Markdown renderer for observer (assistant) messages. Styled entirely through
// the `components` map + Tailwind classes — no typography plugin, no CSS file.
// Block elements are spaced with a flex/gap wrapper so layout is predictable.
